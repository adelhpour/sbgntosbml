...
class SBGNNecessaryStimulation(SBGNConnectingArcBase):
    ...
    def set_geometric_shape_features(self, sbmlnetwork_object, reaction, species):
        ...
        sbmlnetwork_object.addSpeciesReferenceLineEndingGeometricShape(reaction.get_id(), "rendercurve", species_reference_index=species_reference_index)
        geometric_shape_index = sbmlnetwork_object.getNumSpeciesReferenceLineEndingGeometricShapes(reaction.get_id(), species_reference_index=species_reference_index) - 1
        sbmlnetwork_object.setSpeciesReferenceLineEndingGeometricShapeSegmentX(reaction.get_id(), x=-5.0, segment_index=0, species_reference_index=species_reference_index, index=geometric_shape_index)
        sbmlnetwork_object.setSpeciesReferenceLineEndingGeometricShapeSegmentY(reaction.get_id(), y=-2.0, segment_index=0, layout_index=0, species_reference_index=species_reference_index, index=geometric_shape_index)
        sbmlnetwork_object.setSpeciesReferenceLineEndingGeometricShapeSegmentX(reaction.get_id(), x=-5.0, segment_index=1, species_reference_index=species_reference_index, index=geometric_shape_index)
        sbmlnetwork_object.setSpeciesReferenceLineEndingGeometricShapeSegmentY(reaction.get_id(), y=14.0, segment_index=1, layout_index=0, species_reference_index=species_reference_index, index=geometric_shape_index)
